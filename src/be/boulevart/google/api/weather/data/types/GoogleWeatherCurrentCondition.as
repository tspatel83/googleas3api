package be.boulevart.google.api.weather.data.types {
	...
	public class GoogleWeatherCurrentCondition {
		...
		public function GoogleWeatherCurrentCondition(condition:String, temperatureInFahrenheit:int, temperatureInCelsius:int, humidity:uint, wind:String, windDirection:String, windSpeed:uint, icon:String) {
